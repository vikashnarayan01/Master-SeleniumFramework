...
public class CartTest extends BaseTest {
	...
	public void addToCartFromStorePage() throws IOException {
		...
		CartPage cartPage = new StorePage(getDriver()).load().getProductThumbnail().clickaddToCartBtn(product.getName())
				.clickViewCartLink();
	...
	public void addToCartFeaturedProducts(Product product) throws IOException {
		...
		CartPage cartPage = new HomePage(getDriver()).load().getProductThumbnail().clickaddToCartBtn(product.getName())
				.clickViewCartLink();
